...
<head>
  ...
  <style>
    body {
      ...
      background: url("{{ asset('img/bg-minigame.png') }}") no-repeat center center fixed;
...
<body>
  ...
  <a href="{{ route('beranda') }}" class="back-button">
    <img src="{{ asset('img/back-icon.png') }}" alt="Back">
  </a>

  <script>
    const questions = [
      {
        img: "{{ asset('img/apple.png') }}",
        question: "Apa nama buah ini?",
        options: ["Apel", "Jeruk", "Pisang", "Mangga"],
        answer: "Apel"
      },
      {
        img: "{{ asset('img/banana.png') }}",
        question: "Apa nama buah ini?",
      ...
      {
        img: "{{ asset('img/orange.png') }}",
        question: "Apa nama buah ini?",
        options: ["Apel", "Melon", "Jeruk", "Pisang"],
        answer: "Jeruk"
      },
      {
        img: "{{ asset('img/mango.png') }}",
        question: "Apa nama buah ini?",
      ...
      q.options.forEach(opt => {
        ...
        btn.onclick = () => {
          ...
          if (opt === q.answer) {
            ...
            icon.src = "{{ asset('img/icon-benar.png') }}";
            icon.className = "icon";
            ...
            const icon = document.createElement('img');
            icon.src = "{{ asset('img/icon-salah.png') }}";
            icon.className = "icon";
            btn.appendChild(icon);
          }
          setTimeout(() => {
