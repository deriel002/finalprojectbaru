...
<head>
  ...
  <style>
    body {
      ...
      background: url("<?php echo e(asset('img/bg-daily.png')); ?>") no-repeat center center fixed;
...
<body>
  <div class="container">
    ...
    <div class="adventure-box">
      ...
      <div class="flowers">
        <img src="<?php echo e(asset('img/flower1.png')); ?>" alt="Bunga 1" />
        <img src="<?php echo e(asset('img/flower2.png')); ?>" alt="Bunga 2" />
        <img src="<?php echo e(asset('img/flower3.png')); ?>" alt="Bunga 3" />
      </div>
...
<?php /**PATH D:\FinalReal\finalproject\resources\views/daily.blade.php ENDPATH**/ ?>