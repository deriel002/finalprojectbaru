...
<body>
  ...
  <main class="animal-grid">
    <div class="animal-card" onclick="toggleSound('kucing')">
      <img src="<?php echo e(asset('img/kucing.png')); ?>" alt="Kucing" />
      <h2>Kucing</h2>
      <p>Mengeong manja dan suka tidur 😸</p>
    </div>
    <div class="animal-card" onclick="toggleSound('anjing')">
      <img src="<?php echo e(asset('img/anjing.png')); ?>" alt="Anjing" />
      <h2>Anjing</h2>
      <p>Setia dan suka bermain bola!</p>
    </div>
    <div class="animal-card" onclick="toggleSound('kelinci')">
      <img src="<?php echo e(asset('img/kelinci.png')); ?>" alt="Kelinci" />
      <h2>Kelinci</h2>
      <p>Suka wortel dan lompat-lompat!</p>
    </div>
    <div class="animal-card" onclick="toggleSound('burung')">
      <img src="<?php echo e(asset('img/burung.png')); ?>" alt="Burung" />
      <h2>Burung</h2>
      <p>Terbang tinggi dan bernyanyi merdu~</p>
    </div>
  </main>

  <audio id="kucing" src="<?php echo e(asset('audio/kucing.mp3')); ?>"></audio>
  <audio id="anjing" src="<?php echo e(asset('audio/anjing.mp3')); ?>"></audio>
  <audio id="kelinci" src="<?php echo e(asset('audio/kelinci.mp3')); ?>"></audio>
  <audio id="burung" src="<?php echo e(asset('audio/burung.mp3')); ?>"></audio>
...
<?php /**PATH D:\FinalReal\finalproject\resources\views/petzoo.blade.php ENDPATH**/ ?>